...
class Clients
{
     ...
     * @var int
     *
     * @ORM\Column(name="is_trainer", type="integer", nullable=false)
     */
    private $isTrainer = '0';
     ...
     * @var int
     *
     * @ORM\Column(name="traiver_verification_status", type="integer", nullable=false)
     */
    private $traiverVerificationStatus = '0';

    /**
     * @var string
     *
     * @ORM\Column(name="trainer_verification_remarks", type="text", length=65535, nullable=false)
     */
    private $trainerVerificationRemarks;
    ...
    public function getIsTrainer(): ?int
    {
        return $this->isTrainer;
    }

    public function setIsTrainer(int $isTrainer): self
    {
