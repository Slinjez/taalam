...
$("#bio-form").submit(function(c) {
    ...
    var client_allergies = $("#client-allergies").val();
    var client_medical_conditions = $("#client-medical-conditions").val();
    var client_special_needs = $("#client-special-needs").val();
    var client_behavioral_conditions = $("#client-behavioral-conditions").val();

    selected_conditions = $('.trainer-checkbox:checked').map(function () {
    ...
    $.ajax({
        type: "post",
        url: "/client-kid-status-update-revamp",
        data: b,
        dataType: "json",
        beforeSend: function() {
    ...
    $.ajax({
        ...
        success: function (e) {
            if (e.status == 'ok') {
                ...
                $('#client-full-name').val(e.kidsname);
                //$('#client-allergies').val(e.client-phone);
                //$('#display_date').val(e.display_date);
                $('#client-allergies').val(e.allergies);
                $('#client-medical-conditions').val(e.medical_conditions);
                $('#client-special-needs').val(e.special_needs);
                $('#client-behavioral-conditions').val(e.behavioral_conditions);
                $('#dob').val(e.date_of_birth);
